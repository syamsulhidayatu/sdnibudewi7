    ...
    <div class="row">
        <div class="col-lg-8">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <?= form_error('foto_santri', '<small class="text-danger ">', '</small>'); ?>
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <?= form_error('foto_kk_santri', '<small class="text-danger ">', '</small>'); ?>
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <?= form_error('foto_ktp_wali', '<small class="text-danger ">', '</small>'); ?>
            ...
            <div class="form-group row float-right">
                <div class="col-sm-9">
                    <button type="submit" onclick="confirm('Anda yakin dengan data nya? data yang sudah dikirim tidak bisa di edit!')" class="btn btn-primary">Daftar</button>
                </div>
            </div>
